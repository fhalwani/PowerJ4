...
class DPowerJ extends DCore {
	...
	static final byte STM_CD1_INSERT = 10;
	static final byte STM_CD1_SELECT = 11;
	static final byte STM_CD1_UPDATE = 12;
	static final byte STM_CD2_INSERT = 13;
	static final byte STM_CD2_SELECT = 14;
	static final byte STM_CD2_UPDATE = 15;
	static final byte STM_CD3_INSERT = 16;
	static final byte STM_CD3_SELECT = 17;
	static final byte STM_CD3_UPDATE = 18;
	static final byte STM_CD4_INSERT = 19;
	static final byte STM_CD4_SELECT = 20;
	static final byte STM_CD4_UPDATE = 21;
	static final byte STM_CMT_INSERT = 22;
	static final byte STM_CMT_SELECT = 23;
	static final byte STM_CMT_UPDATE = 24;
	static final byte STM_CSE_INSERT = 25;
	static final byte STM_CSE_SELECT = 26;
	static final byte STM_CSE_SL_CID = 27;
	static final byte STM_CSE_SL_CNO = 28;
	static final byte STM_CSE_SL_DTE = 29;
	static final byte STM_CSE_SL_SPE = 30;
	static final byte STM_CSE_SL_SUM = 31;
	static final byte STM_CSE_SL_TAT = 32;
	static final byte STM_CSE_SL_WLD = 33;
	static final byte STM_CSE_SL_YER = 34;
	...
	static final byte STM_FRZ_SL_SU5 = 47;
	static final byte STM_FRZ_SL_SUM = 48;
	static final byte STM_FRZ_UPDATE = 49;
	static final byte STM_ORD_INSERT = 50;
	static final byte STM_ORD_SELECT = 51;
	static final byte STM_ORD_UPDATE = 52;
	static final byte STM_ORG_INSERT = 53;
	static final byte STM_ORG_SELECT = 54;
	static final byte STM_ORG_UPDATE = 55;
	static final byte STM_ORM_INSERT = 56;
	static final byte STM_ORM_SELECT = 57;
	static final byte STM_ORM_UPDATE = 58;
	static final byte STM_ORT_INSERT = 59;
	static final byte STM_ORT_SELECT = 60;
	static final byte STM_PND_DEL_FN = 61;
	static final byte STM_PND_DEL_ID = 62;
	static final byte STM_PND_INSERT = 63;
	static final byte STM_PND_SELECT = 64;
	static final byte STM_PND_SL_LST = 65;
	static final byte STM_PND_SL_ROU = 66;
	static final byte STM_PND_UP_EMB = 67;
	static final byte STM_PND_UP_FIN = 68;
	static final byte STM_PND_UP_GRS = 69;
	static final byte STM_PND_UP_MIC = 70;
	static final byte STM_PND_UP_ROU = 71;
	static final byte STM_PND_UP_SCA = 72;
	static final byte STM_PRO_INSERT = 73;
	static final byte STM_PRO_SELECT = 74;
	static final byte STM_PRO_UPDATE = 75;
	static final byte STM_PRS_INSERT = 76;
	static final byte STM_PRS_SELECT = 77;
	static final byte STM_PRS_SL_PID = 78;
	static final byte STM_PRS_UPDATE = 79;
	static final byte STM_RUL_INSERT = 80;
	static final byte STM_RUL_SELECT = 81;
	static final byte STM_RUL_UPDATE = 82;
	static final byte STM_SCH_DELETE = 83;
	static final byte STM_SCH_INSERT = 84;
	static final byte STM_SCH_SL_MON = 85;
	static final byte STM_SCH_SL_SRV = 86;
	static final byte STM_SCH_SL_STA = 87;
	static final byte STM_SCH_SL_SUM = 88;
	...
	static final byte STM_SPG_SL_SU5 = 95;
	static final byte STM_SPG_SL_SUM = 96;
	...
	static final byte STM_STP_SELECT = 109;
	static final byte STM_STP_SL_SID = 110;
	static final byte STM_STP_UPDATE = 111;
	static final byte STM_SUB_INSERT = 112;
	static final byte STM_SUB_SELECT = 113;
	static final byte STM_SUB_UPDATE = 114;
	static final byte STM_TUR_INSERT = 115;
	static final byte STM_TUR_SELECT = 116;
	static final byte STM_TUR_UPDATE = 117;
	static final byte STM_WDY_INSERT = 118;
	static final byte STM_WDY_SELECT = 119;
	static final byte STM_WDY_SL_DTE = 120;
	static final byte STM_WDY_SL_LST = 121;
	static final byte STM_WDY_SL_NXT = 122;
	static final byte STM_WDY_SL_PRV = 123;
