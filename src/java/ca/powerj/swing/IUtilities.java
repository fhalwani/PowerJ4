...
public class IUtilities {
	...
	public static JLabel createJLabel(int horizontalAlignment, int mnemonic, String text) {
		JLabel lbl = new JLabel(text);
		lbl.setFont(LibConstants.APP_FONT);
	...
	public static JButton createJButton(int size, int mnemonic, String text) {
	...
	public static JScrollPane createJScrollPane(Component c) {
	...
	public static ImageIcon getIcon(int size, String name) {
	...
	public static Image getImage(int size, String name) {
