...
public class IChartPie extends IChartBase {
	public static final byte COLOR_DEF = 0;
	public static final byte COLOR_RAG = 1;

	public IChartPie(Dimension dim) {
		super(dim);
	}
	...
	public void setChart(String[] xData, double[] yData, String caption, byte color) {
